...
const navigationSlice = createSlice({
  ...
  reducers: {
    ...
    setPostHeight(state, action: PayloadAction<number>) {
      state.postHeight = action.payload;
    },
    resetNavigation(state) {
      ...
      state.cartID = null;
      state.couponID = null;
      state.postHeight = null;
    },
  },
});

export const { setCurrentSlide, setRecipeID, setBusinessID, resetNavigation, setPostID, setFeedData, setOrderID, setCartID, setCouponID, setPostHeight } = navigationSlice.actions;
