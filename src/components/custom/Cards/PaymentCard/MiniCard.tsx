...
import { Delete03IconSharp, PlusSignIcon } from "../../../../constants/IconsPro";
import FlexContainer from "../../FlexContainer";
import { iconsNative } from "../../../../constants";
import { COLORS, FONTS, responsiveFontSize, SIZES } from "../../../../constants/theme";
import { useTheme } from "../../../../hooks";
import Typography from "../../Typography";
import { Pressable, Image, useNavigation } from "../../../native";
import { Checkbox } from "../../Checkbox";
import Icons from "../../Icons";
import { AddPayment } from "../../../../screens/Settings/Generals/Payments Methods/components";
...
const MiniCard = ({ row, index, scrollX }: Props) => {
  const { Title, Description, borderInput, backgroundMaingrey, BackgroundMain } = useTheme();
    ...
    >
      {
        ...
        <FlexContainer>
          ...
          <Typography variant="title" newStyle={styles.brand}>{row?.brand}</Typography>
