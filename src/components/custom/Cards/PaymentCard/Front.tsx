...
const Front = (props: Props) => {
  ...
  >
    <FlexContainer newStyle={styles.container}>
      <View>
        <Typography variant='title' newStyle={styles.title}>{props.namecard === '' ? 'Card name' : props.namecard }</Typography>
      ...
      >
        ...
        >
          <Image
            style={{ width: responsiveFontSize(25), height: responsiveFontSize(30) }}
        ...
        <Image
          style={{ marginBottom: responsiveFontSize(75), width: responsiveFontSize(30), height: responsiveFontSize(30) }}
          source={iconsNative.cardTouch}
          tintColor={Title}
        />
        {props.brand == "Visa" && (
          <Image
            style={{ width: responsiveFontSize(130), height: responsiveFontSize(40) }}
            source={iconsNative.visa}
          />
        )}
        {props.brand == "MasterCard" && (
          <Image
            style={{ width: responsiveFontSize(65), height: responsiveFontSize(40) }}
        ...
        {props.brand == "AmericanExpress" && (
          <Image
            style={{ width: responsiveFontSize(40), height: responsiveFontSize(40) }}
