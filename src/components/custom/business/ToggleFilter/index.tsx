...
const ToggleFilter = (props: Props) => {
    const { onPressStores, onPressFreeShipping, filterStores, freeShipping, rating } = props;
    const { bgInput, borderInput, color, backgroundMaingrey, Description, border } = useTheme();
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity
                ...
                newStyle={{
                    ...
                    {freeShipping ? i18next.t('All shipments') : i18next.t('Free shipping only')}
                </Typography>
            </TouchableOpacity>
        </View>
    )
