...
const useTheme = () => {
  ...
  const BgTransparent = isDark ? "rgba(255, 255, 255, 0.4)" : "rgba(255, 255, 255, 0.1)"
  const BackSecundary = isDark ? COLORS.BgDark : lightTheme.backgroundColor
  const BackgroundMain = isDark ? COLORS.BackgroundMain : COLORS.BackgroundMainLight
  const backgroundMaingrey = isDark ?  COLORS.backgroundMaingrey : COLORS.backgroundMaingreyLight
