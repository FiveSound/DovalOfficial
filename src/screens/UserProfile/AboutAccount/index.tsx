      ...
      <FlexContainer newStyle={styles.containerMain}>
        <FlexContainer newStyle={styles.container}>
          ...
          <Typography variant="SubDescription" newStyle={styles.title}>
            {row.userDetails.transparencyDescription ||
              i18next.t(
                'To foster transparency and build trust, Doval displays key information about each creators account.',
              )}
          </Typography>
            ...
            <Icons
              ...
              appendIcons={
                <FlexContainer variant="row" newStyle={styles.iconsContainer}>
                  ...
                  <Typography variant="H4title" newStyle={styles.title}>
                    {' '}
                    {i18next.t('Joined Doval:')}
                    <Typography
                      variant="SubDescription"
                      newStyle={styles.title}
                    >
                      {' '}
                      {row.userDetails.joinedDoval}
                    </Typography>
                  </Typography>
                </FlexContainer>
              }
