...
import { TouchableOpacity, Image, useNavigation } from "../../../components/native";
import { useAuth } from "../../../context/AuthContext";
import * as Haptics from "expo-haptics";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { getFollowingProfileService, handleProfileFollowingService } from "../../../services/follows";
...
const CtoUserProfile = ({
  ...
  const { data: dataCto, isError, isLoading, isFetching } = useQuery({
...
const MoreOptions = ({ data }: { data: any }) => {
  ...
  return (
    <FlexContainer variant="row" newStyle={styles.moreOptionsContainer}>
      ...
      <Icons appendIcons={<MoreHorizontalCircle01Icon width={SIZES.icons} height={SIZES.icons} color={Title} />}
