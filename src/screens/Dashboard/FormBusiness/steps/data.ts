const ListBank = [
    { label: "Banco de Reservas (Banreservas)", value: "Banco de Reservas (Banreservas)" },
    { label: "Banco Popular Dominicano", value: "Banco Popular Dominicano" },
    { label: "Banco BHD León", value: "Banco BHD León" },
    { label: "Scotiabank República Dominicana", value: "Scotiabank República Dominicana" },
    ...
    { label: "Banco Nacional de Crédito (Bancredito)", value: "Banco Nacional de Crédito (Bancredito)" },
    { label: "Banco Sofitasa", value: "Banco Sofitasa" },
    { label: "Banco F&C", value: "Banco F&C" },
    { label: "Banco Agrícola de la República Dominicana (BAR)", value: "Banco Agrícola de la República Dominicana (BAR)" },
  ];
