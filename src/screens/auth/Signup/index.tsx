    ...
    >
      <FormBottom
        ...
        <ButtonIcons
          ...
          Icons={<SmartPhone01Icon width={SIZES.icons} height={SIZES.icons} color={Title}/>}
        ...
        <Typography variant="SubDescription" newStyle={styles.text}>
          ...
          <Typography
            variant='H4title'
            onPress={() => handleLinkPress('https://example.com/terms-and-conditions')}
          >
          ...
          <Typography
            variant='H4title'
            onPress={() => handleLinkPress('https://example.com/privacy-policy')}
          >
          ...
          <Typography
            variant='H4title'
            onPress={() => handleLinkPress('https://example.com/terms-of-service')}
          >
            {i18next.t('Terms of Service')}
          </Typography>
          {i18next.t('. We prioritize the protection of your personal information and adhere to strict data privacy standards.')}
        </Typography>
      </FormBottom>
    </AuthLayout>
  );
