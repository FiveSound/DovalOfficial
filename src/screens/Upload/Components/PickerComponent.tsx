...
import { FlexContainer, Icons, IsLoading, Typography } from '../../../components/custom';
import { Modal, ScrollView, TouchableOpacity, View } from '../../../components/native';

interface PickerComponentProps {
    items: Array<{ title: string; id: string; assetCount: string; uriAsset: string }>;
    onValueChange: (value: string) => void;
}

const PickerComponent = React.memo(({ items, onValueChange }: PickerComponentProps) => {
    ...
    const handleSelect = useCallback((item: { title: string; id: string; assetCount: string; uriAsset: string }) => {
    ...
    return (
        <FlexContainer style={styles.container}>
            <TouchableOpacity
                ...
                variant='title'>{selectedTitle || 'Recientes'}</Typography>
                <ArrowDown01Icon
            ...
            appendIcons={
                ...
                <Home01Icon  color={BackgroundMain}  width={SIZES.icons} height={SIZES.icons}/>
            ...
            <Modal
                ...
                <View style={[styles.modalView, { backgroundColor: bgInput, borderColor: bgInput }]}>
