...
import {
  ArrowDown01Icon,
  ArrowDown01IconStroke,
  LoginMethodIcon,
  SafeDelivery01Icon,
  SecurityCheckIconSharp,
...
const ModalPin = () => {
  ...
  return (
    <FlexContainer
      newStyle={[styles.container, { backgroundColor: backgroundMaingrey }]}
    >
      ...
      <InfoCard
        ...
        description={i18next.t(
          'The unique PIN ensures only you can confirm the delivery, preventing fraud.',
        )}
      />
      <InfoCard
        icon={
        ...
        description={i18next.t(
          'Provide the PIN to the delivery person to ensure your order reaches you.',
        )}
      />
      <InfoCard
        icon={
        ...
        description={i18next.t(
          'Use the PIN to confirm receipt and avoid delivery mistakes.',
        )}
      />
    </FlexContainer>
  );
