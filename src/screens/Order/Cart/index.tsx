...
import { Accordion, Container, LoadingScreen, ScreenEmpty, SignupAlert } from "../../../components/custom";
...
const Cart = memo(() => {
  ...
  const { isLoadingApp, isAuthenticated } = useSelector((state: RootState) => state.auth);
  ...
  if (isError)
    return <ScreenEmpty source={Ilustrations.CharcoPet} labelPart1={i18next.t("Oops! Error getting cart")} />;
