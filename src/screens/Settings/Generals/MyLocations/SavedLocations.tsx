...
import { Container, FlexContainer, LineDivider, Typography } from "@/src/components/custom";
import { COLORS, SIZES } from "@/src/constants/theme";
import { useTheme } from "@/src/hooks";
import { CheckmarkCircle02Icon, Location09Icon } from "@/src/constants/IconsPro";
...
const SavedLocations = memo((props: Props) => {
  ...
  const handleDefault = async (locationID: string) => {
    try {
      ...
      console.error("Error al establecer la ubicación predeterminada:", error);
    }
  };
